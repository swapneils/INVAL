...
(defparameter *max-tests-per-domain* 2)

(defparameter *run-as-script* nil
  "Determines whether we're running this as a script")
...
;;
;; (setq *run-as-script* t)
;;;;

(setq *max-tests-per-domain* 2)

(defun run-run-val-test-ipc4 ()
  (handler-bind
